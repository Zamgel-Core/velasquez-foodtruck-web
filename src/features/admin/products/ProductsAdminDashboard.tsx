      ...
      <div className="max-h-[92vh] w-full max-w-2xl overflow-y-auto rounded-3xl border border-white/10 bg-[#0a0a0a] p-5 text-white shadow-2xl">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <label className="sm:col-span-2">
            <span className="mb-2 block text-sm font-bold text-white/70">Nombre</span>
            <input
              value={form.name}
          ...
          <label>
            <span className="mb-2 block text-sm font-bold text-white/70">Precio</span>
            <input
              value={form.price}
          ...
          <label>
            <span className="mb-2 block text-sm font-bold text-white/70">Tiempo prep. min</span>
            <input
          ...
          <label className="sm:col-span-2">
            <span className="mb-2 block text-sm font-bold text-white/70">Imagen URL</span>
            <input
      ...
      <section className="mx-auto max-w-7xl">
        ...
        {!loading && filteredProducts.length === 0 && (
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-8 text-center">
            ...
            <h2 className="text-xl font-black">No hay productos para mostrar</h2>
              ...
              >
                ...
                <div className="flex flex-col gap-2 lg:min-w-[220px]">
                  ...
                  >
                    ...
                    <span className="ml-2 text-xs text-white/40">Cambiar</span>
                  </button>

...
export function FeatureStrip({ lang }: { lang: Lang }) {
  ...
  return (
    <section className="relative overflow-hidden border-y border-white/10 bg-zinc-950 px-4 py-10">
      ...
      <div className="absolute left-1/2 top-1/2 h-56 w-56 -translate-x-1/2 -translate-y-1/2 rounded-full bg-red-600/10 blur-3xl" />
      ...
      <div className="relative mx-auto grid max-w-7xl gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {features.map(([Icon, label], index) => (
          <motion.div
            ...
            className="group rounded-3xl border border-white/10 bg-white/[0.035] p-6 text-center shadow-xl shadow-black/20 transition hover:-translate-y-1 hover:border-red-500/35 hover:bg-red-500/[0.06] hover:shadow-red-950/20"
          >
            <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-2xl border border-red-500/25 bg-red-500/10 text-red-400 transition group-hover:scale-110 group-hover:bg-red-500 group-hover:text-white">

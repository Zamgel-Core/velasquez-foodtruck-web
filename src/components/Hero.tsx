import { Flame, MessageCircle, Navigation, Phone } from "lucide-react";
import { motion } from "motion/react";
import { mapsUrl, phone, whatsapp } from "../data/business";

type HeroProps = {
  businessStatus: { isOpen: boolean; label: string };
  t: {
    openNow: string;
    hero1: string;
    hero2: string;
    ...
    <section id="home" className="relative flex min-h-[100svh] items-center overflow-hidden bg-black pt-24">
      ...
      >
        <div className="max-w-2xl">
          ...
          <p className="mt-6 max-w-xl text-base text-white/75 sm:text-xl">{t.heroText}</p>
